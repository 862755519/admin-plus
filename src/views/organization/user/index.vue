...
<template>
  <div>
    <PageTitle
      title="用户管理"
      subTitle="用户管理，用户负责人、用户成员、用户职责管理。"
    ></PageTitle>
    <div class="page-content">
      ...
      <div class="page-table-box">
        ...
        >
          ...
          <vxe-column field="name" title="姓名" width="80"></vxe-column>
          <vxe-column field="mobile" title="电话" width="100"></vxe-column>
          <vxe-column field="email" title="邮箱" width="150"></vxe-column>
          ...
          <vxe-column
            ...
            width="100"
          ></vxe-column>
          <vxe-column field="address" title="住址" width="300"></vxe-column>
          <vxe-column
            field="descript"
            title="用户描述"
            min-width="100"
...
<script setup>
//表单对象
import { getUserList } from "@/api/modules/organization";
