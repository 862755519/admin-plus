...
<template>
  <div>
    <PageTitle
      title="部门管理"
      subTitle="部门管理，部门负责人、部门成员、部门职责管理。"
    ></PageTitle>
    <div class="page-content">
      ...
      <div class="page-table-box">
        ...
        >
          ...
          <vxe-column field="name" title="部门名称" width="200"></vxe-column>
          <vxe-column field="principal" title="部门负责人" width="110"></vxe-column>
          <vxe-column
            field="personNumber"
            title="成员数量"
            width="110"
...
<script setup>
//表单对象
import { getDepartmentList } from "@/api/modules/organization";
